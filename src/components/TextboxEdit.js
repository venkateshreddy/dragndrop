...
class TextboxEdit extends React.Component{
	render(){
		var element = this.props.element;
		return(
			<div className="edit_div">
	            <span><h2>Editing textbox {element.name}</h2></span>
	        	<form>
...
export default connect(mapStateToProps, mapDispatchToProps)(TextboxEdit);
